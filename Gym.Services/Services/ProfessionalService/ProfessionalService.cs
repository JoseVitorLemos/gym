...
public class ProfessionalService : IProfessionalService
{
    ...
    public async Task<bool> InsertProfessional(ProfessionalDTO model)
        => await _professionalBusiness.InsertProfessional(_mapper.Map<Professional>(model));

    public async Task<bool> UpdateProfessional(ProfessionalDTO model)
        => await _professionalBusiness.UpdateProfessional(_mapper.Map<Professional>(model));
